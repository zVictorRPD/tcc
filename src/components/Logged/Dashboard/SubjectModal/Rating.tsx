import { Box, Button, Divider, Flex, Grid, GridItem, Slider, SliderFilledTrack, useToast, SliderThumb, SliderTrack, Text, Textarea, SkeletonText, Skeleton, Avatar, Tooltip } from '@chakra-ui/react'
...
function Rating() {
    ...
    const { selectedSubject, userId } = useContext(DashboardContext);
