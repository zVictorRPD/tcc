...
export const funcitonalites:IFunctionalities[] = [
    {
        ...
        dark_icon: <FaUserGraduate fontSize={'2.25rem'} color={'#FFFFFF'}/>,
    ...
    },
    {
        ...
        dark_icon: <FaRegClock fontSize={'2.25rem'} color={'#FFFFFF'}/>,
        title: "Grade horária",
    ...
    },
    {
        ...
        dark_icon: <FaChalkboardTeacher fontSize={'2.25rem'} color={'#FFFFFF'}/>,
        title: "Professores",
    ...
    },
    {
        ...
        dark_icon: <FaCalendarAlt fontSize={'2.25rem'} color={'#FFFFFF'}/>,
        title: "Calendário",
    ...
    },
    {
        ...
        dark_icon: <AiFillAppstore fontSize={'2.25rem'} color={'#FFFFFF'}/>,
        title: "Dashboard",
    ...
    },
    {
        ...
        dark_icon: <FaMapMarkedAlt fontSize={'2.25rem'} color={'#FFFFFF'}/>,
        title: "Mapa",
